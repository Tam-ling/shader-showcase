    ...
    >
      ...
      >
        <div className="card-nav-top absolute inset-x-0 top-0 h-[60px] flex items-center justify-between p-2 pl-[1.1rem] z-[2]">
          ...
          <div className="rounded-xl bg-black p-1.5 flex items-center justify-center ml-auto mx-3 px-2.5 py-2.5">
            <AnimatedThemeToggler />
          </div>
          <button
            type="button"
            className="card-nav-cta-button hidden md:inline-flex border-0 rounded-[calc(0.75rem-0.2rem)] px-6 h-full font-medium cursor-pointer transition-colors duration-300 items-center justify-center"
